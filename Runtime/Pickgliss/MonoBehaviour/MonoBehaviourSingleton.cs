...
///     Upon loading it will call Don'tDestroyOnLoad on the gameobject where this script is contained
...
/// </remarks>
namespace Pickgliss.MonoBehaviour
{
    public class MonoBehaviourSingleton<T> : UnityEngine.MonoBehaviour where T : UnityEngine.MonoBehaviour
    {
        ...
        #region Unity3d Messages - DO NOT OVERRIDE / IMPLEMENT THESE METHODS in child classes!
        void Awake()
        {
